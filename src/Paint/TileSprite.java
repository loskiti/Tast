...
public class TileSprite extends Tile {
	// размеры картинки на спрайте!
	 public int width;
	    ...
	    public TileSprite(String image, int posX, int posY, int width, int height, int offsetX, int offsetY, boolean isWalkable, int door, int layerDeep) {
	    ...
	    public void render(Graphics g) {   
	        ...
	        g.drawImage(getImage(image), isoX + Game.OFFSET_MAP_X, isoY, isoX + width + Game.OFFSET_MAP_X, isoY + height, offsetX, offsetY, offsetX + width, offsetY + height, null);
	    }
}
